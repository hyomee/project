...
public class GsonUtils {
        ...
        private static Gson gson = new GsonBuilder()
            ...
            .setDateFormat(CommonConstant.PATTERN_DATETIME)
        ...
        static class LocalDateAdapter extends TypeAdapter<LocalDate> {
            DateTimeFormatter format = DateTimeFormatter.ofPattern(CommonConstant.PATTERN_DATE);
        ...
        static class LocalTimeAdapter extends TypeAdapter<LocalTime> {
            DateTimeFormatter format = DateTimeFormatter.ofPattern(CommonConstant.PATTERN_TIME);
            @Override
